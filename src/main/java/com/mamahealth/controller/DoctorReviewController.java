...
public class DoctorReviewController {
    ...
    /**
     * Get Doctor Review by Recovery Record
     */
    @GetMapping("/{recoveryId}")
    public ResponseEntity<DoctorReviewResponse> getReview(
            @PathVariable Long recoveryId) {
    ...
    public ResponseEntity<String> deleteReview(
        ...
        return ResponseEntity.ok("Doctor review deleted successfully.");
    }
}